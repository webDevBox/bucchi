        ...
        <div class="content-body">
            ...
            <div style="background-color: white;">
                ...
                <div id="multi-step-form-container">
                    ...
                    <form action="#" id="userAccountSetupForm" name="userAccountSetupForm" enctype="multipart/form-data"
                        method="POST">
                        <!-- Step 1 Content -->
                        <section id="step-1" class="form-step">
                            ...
                            <div class="mt-3">
                                <button class="button " type="button" onclick="createClient(2)"
                        ...
                        <section id="step-2" class="form-step d-none">
                            ...
                            <div class="mt-3 offset-3">
                                ...
                                <div class="form-group d-none" id="currency_div">
                                    ...
                                    <label class="col-md-12 h5 control-label" for="order_currency ">Enter
                                        Currency</label>
                            ...
                            <div class="mt-3">
                                ...
                                <button class="button " onclick="addOrderDetails(3)" type="button"
                            ...
                            <div class="mt-3">
                                ...
                                <div id="paymentAdder" class="row d-none">
                                    ...
                                    <div class="col-md-2 col-sm-12">
                                        <button onclick="delPayment()" class="btn btn-danger payment_deleter"><i
