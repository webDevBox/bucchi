                ...
                <ul class="nav navbar-nav align-items-center ml-auto">
                    <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user"><a
                                class="dropdown-item" href="{{ route('adminProfile') }}"><i class="mr-50" data-feather="user"></i> Profile</a>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i class="fa fa-cart-plus"
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="d-flex align-items-center" href="{{ route('createOrder') }}"><i
                        ...
                        <li>
                            <a class="d-flex align-items-center" href="{{ route('draftOrders') }}"><i
                                    class="fa fa-circle" style="color:  #6610F2" aria-hidden="true"></i><span
                                    class="menu-title text-truncate" data-i18n="Email">Draft Orders</span></a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="{{ route('outfitChanges') }}"><i
                                    class="fa fa-circle" style="color:  #6610F2" aria-hidden="true"></i><span
                                    class="menu-title text-truncate" data-i18n="Email">Update Orders</span></a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="{{ route('viewOrder') }}"><i class="fa fa-circle"
                                    style="color:  #6610F2" aria-hidden="true"></i><span
                                    class="menu-title text-truncate" data-i18n="Email">View Orders</span></a>

                        </li>
                        <li>
                            <a class="d-flex align-items-center" href="{{ route('searchOrder') }}"><i
                                class="fa fa-circle" style="color:  #6610F2" aria-hidden="true"></i><span
                                class="menu-title text-truncate" data-i18n="Email">Search Order</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('clientPage') }}"><i
                ...
                <li class=" nav-item d-none d-md-block"><a class="d-flex align-items-center" href="{{ route('scheduling') }}"><i class="fa fa-ravelry" style="color:  #6610F2" aria-hidden="true"></i><span class="menu-title text-truncate" >Scheduling</span></a>
                </li>
